# Cognitive Services beginner track
...
* Clone this repository to your local machine to gain images and code samples you need for the demos: ```git clone https://github.com/EelcoKoster/cognitiveservices.git``` or choose 'Clone or Download' green button and then 'Download ZIP'
